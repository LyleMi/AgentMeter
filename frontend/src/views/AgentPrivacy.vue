                ...
                <article v-for="setting in group.items" :key="setting.id" :class="settingCardClass(setting)">
                  <div class="privacy-setting-main">
                    <div class="privacy-setting-heading">
                      <div>
                        <div class="privacy-setting-title">{{ localizedSettingTitle(setting) }}</div>
                        <div class="privacy-setting-description">{{ localizedSettingDescription(setting) }}</div>
                      </div>
                    ...
                    <div v-if="setting.impact" class="privacy-impact">{{ localizedSettingImpact(setting) }}</div>
